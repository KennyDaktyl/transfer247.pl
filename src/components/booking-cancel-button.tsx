  ...
  return (
    <div className="flex flex-col items-start gap-1">
      <button
        ...
        disabled={cancelling}
        className="text-muted decoration-muted/50 text-[12.5px] font-semibold underline underline-offset-2 transition-colors hover:text-red-600 disabled:opacity-60"
      >
